...
extern "C" {
    ...
    typedef enum {
        ...
        ERROR_CODE_A = 0x7D,
        ERROR_CODE_B = 0x7E,
        CONFIGURATION_INFO = 0x7F,
        STORE_LOAD_AND_RESTORE = 0x80,
        SET_SERIAL_NUMBER_1 = 0x81,
        SET_SERIAL_NUMBER_2 = 0x82,
        SET_SERIAL_NUMBER_3 = 0x83,
        SET_SERIAL_NUMBER_4 = 0x84,
        SET_PART_NUMBER_1 = 0x85,
        SET_PART_NUMBER_2 = 0x86,
        SET_PART_NUMBER_3 = 0x87,
        SET_CHANNEL_MAX_CURRENT = 0x88,
        SET_OTHER_CONFIG = 0x89,
        SET_BOOTLOADER_ON = 0x8A,
        READ_ERROR_LOGS_IN_CH0 = 0x8B,
        READ_ERROR_LOGS_IN_CHA = 0x8C,
        READ_ERROR_LOGS_IN_CHB = 0x8D,
        //..........
