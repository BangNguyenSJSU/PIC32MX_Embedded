...
extern "C" {
    ...
    typedef enum {
        ...
        //        COMM_REG_CHANNEL_MAX_CURRENT_1, // Need to move 
        //        COMM_REG_CHANNEL_MAX_CURRENT_2, // Need to move 
        //        COMM_REG_CHANNEL_MAX_CURRENT_3, // Need to move 
        //        COMM_REG_CHANNEL_MAX_CURRENT_4, // Need to move 
        //        COMM_REG_CHANNEL_MAX_CURRENT_5, // Need to move 
        ...
        COMM_REG_CHANNEL_MAX_CURRENT_4, // Need to move 
        COMM_REG_CHANNEL_MAX_CURRENT_5, // Need to move
        COMM_REG_CURRENT_CHANNEL_1, // Need to move 
        COMM_REG_VOLTAGE_CHANNEL_1, // Need to move 
        COMM_REG_STATUS_CHANNEL_1, // Need to move 
        COMM_REG_CURRENT_CHANNEL_2, // Need to move 
        COMM_REG_VOLTAGE_CHANNEL_2, // Need to move 
        COMM_REG_STATUS_CHANNEL_2, // Need to move 
        COMM_REG_CURRENT_CHANNEL_3, // Need to move 
        COMM_REG_VOLTAGE_CHANNEL_3, // Need to move 
        COMM_REG_STATUS_CHANNEL_3, // Need to move 
        COMM_REG_CURRENT_CHANNEL_4, // Need to move
        COMM_REG_VOLTAGE_CHANNEL_4, // Need to move 
        COMM_REG_STATUS_CHANNEL_4, // Need to move 
        COMM_REG_CURRENT_CHANNEL_5, // Need to move 
        COMM_REG_VOLTAGE_CHANNEL_5, // Need to move 
        COMM_REG_STATUS_CHANNEL_5, // Need to move 
        ...
        COMM_REG_CHANNEL_ENABLE, // Need to update New Address
