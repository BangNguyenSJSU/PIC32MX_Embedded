...
extern "C" {
    ...
    // startingAddress: the starting address of the registers to read
    // registerCount: the number of registers to read
    // outputBuffer: a buffer where the read values will be stored
    ...
    // Function to perform a write operation on multiple Modbus registers
    // startingAddress: the starting address of the registers to write
    // registerCount: the number of registers to write
